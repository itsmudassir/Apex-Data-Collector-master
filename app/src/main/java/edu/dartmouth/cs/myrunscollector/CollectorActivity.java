...
public class CollectorActivity extends Activity {
	...
	private final RadioButton[] radioBtns = new RadioButton[10];
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main);
		 radioGroup = (RadioGroup) findViewById(R.id.radioGroupLabels);
	        ...
	        radioBtns[3] = (RadioButton) findViewById(R.id.radioSitting);
	        radioBtns[4] = (RadioButton) findViewById(R.id.radioLaying);
	        radioBtns[5] = (RadioButton) findViewById(R.id.radioIdle);
	        radioBtns[6] = (RadioButton) findViewById(R.id.radioUpStairs);
	        radioBtns[7] = (RadioButton) findViewById(R.id.radioDownStairs);

	        radioBtns[8] = (RadioButton) findViewById(R.id.radioOther);
	...
	public void onCollectClicked(View view) {
        ...
        if (mState == State.IDLE) {
            ...
            radioBtns[6].setEnabled(false);
            radioBtns[7].setEnabled(false);
            radioBtns[8].setEnabled(false);
            ...
            radioBtns[6].setEnabled(true);
            radioBtns[7].setEnabled(true);
            radioBtns[8].setEnabled(true);
